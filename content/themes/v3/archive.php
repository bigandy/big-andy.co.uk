<?php get_header(); ?>
			...
			<div class="content">
				...
				<div class="wrap clearfix inner-content">
				    ...
				    <div class="twelve first clearfix main" role="main">
					    ...
					    <article <?php post_class('clearfix'); ?> role="article">
						    ...
						    <header class="article-header">
							    ...
							    <h3 class="h2"><a href="<?php the_permalink() ?>" rel="bookmark"><?php the_title(); ?></a></h3>
