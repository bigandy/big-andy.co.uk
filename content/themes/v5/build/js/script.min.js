...
var cb=function(){var e=document.createElement("link");e.rel="stylesheet",e.href="/content/themes/v5/style.css";var t=document.getElementsByTagName("head")[0];t.appendChild(e)},raf=requestAnimationFrame||mozRequestAnimationFrame||webkitRequestAnimationFrame||msRequestAnimationFrame;raf?raf(cb):window.addEventListener("load",cb);
!function(e){"use strict";function t(t){var a="//api.openweathermap.org/data/2.5/weather?q=oxford,uk&units=metric&APPID=d8c7ee9216b8e2039669c7b012fcc66e";e.ajax({dataType:"jsonp",url:a,success:function(e){console.log(e),console.log("weather is "+e.weather[0].main),i.text(e.weather[0].main+"y")}})}var a=document.getElementsByClassName("article__link"),o=a.length,n=o,i=e(".home__weather");for(localStorage.setItem("visited-"+window.location.pathname,!0);n--;){var r=a[n];r.host===window.location.host&&localStorage.getItem("visited-"+r.pathname)&&(r.parentNode.parentNode.parentNode.dataset.visited=!0)}t()}(jQuery);