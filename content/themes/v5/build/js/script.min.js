...
!function(e){"use strict";function t(){var t="http://api.openweathermap.org/data/2.5/weather?q=oxford,uk&units=metric&APPID=d8c7ee9216b8e2039669c7b012fcc66e";e.ajax({dataType:"jsonp",url:t,success:function(e){i.text(e.weather[0].main+"y")}})}var a=document.getElementsByClassName("article__link"),o=a.length,n=o,i=e(".home__weather");for(localStorage.setItem("visited-"+window.location.pathname,!0);n--;){var r=a[n];r.host===window.location.host&&localStorage.getItem("visited-"+r.pathname)&&(r.parentNode.parentNode.parentNode.dataset.visited=!0)}t()}(jQuery);