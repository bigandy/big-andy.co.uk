...
var links=document.getElementsByClassName("article__link"),linksLength=links.length,i=linksLength;for(localStorage.setItem("visited-"+window.location.pathname,!0);i--;){var link=links[i];link.host===window.location.host&&localStorage.getItem("visited-"+link.pathname)&&(link.parentNode.parentNode.parentNode.dataset.visited=!0)}